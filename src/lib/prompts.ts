...
【标签】
必须从以下标签库中选择，除非确实没有匹配的标签：
体裁标签：诗、词、赋、文、骈文、乐府、民谣、词牌、律诗、绝句、古风
主题标签：楚辞、咏物、时令、写雪、梅花、柳树、写山、黄河、写马、爱国、思乡、励志、悼亡、母亲、读书、婉约、友情、惜时、豪放、边塞、春节、清明、中秋、抒情、送别、爱情、闺怨、老师、战争、忧民、山水、闲适、怀古、写景、人物、羁旅、孤寂、哲理、田园、家庭、饮酒、登临、咏怀、梦、夜、隐逸、愁绪、赠答、怀人、行旅、贬谪、秋思、盛世、思妇、春景、秋景
若确需使用库外标签，在标签名后加 * 标记为新推荐标签。输出 5-8 个标签。`;
...
1. 注释和赏析不得编造出处。
2. 译文应忠实原文；现代白话诗可留空。
3. 标签 5-8 个，必须从以下标签库中选择（库外标签加 * 标记）：
