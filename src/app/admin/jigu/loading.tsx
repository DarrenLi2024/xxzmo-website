...
export default function AdminJiguLoading() {
  return (
    <div>
      <h2 className="text-2xl font-serif text-ink-900 mb-8">辑古录管理</h2>
      <div className="bg-paper-50 border border-paper-200 rounded-lg overflow-hidden">
        ...
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="grid grid-cols-12 gap-2 px-4 py-3 items-center border-b border-paper-100">
            ...
            <div className="col-span-2 h-5 bg-paper-200 rounded w-20" />
